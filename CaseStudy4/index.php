...
<div class="container">
    <h2>BIO-DATA</h2>
    <form action="index_handler.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">

    <div class="section">UPLOAD PHOTO</div>
        ...
        <table border="0">
            ...
            <tr>
                <td>City Address: <input type="text" placeholder="Ex. Brgy. San Isidro" name="city_address" required></td>
            ...
            <tr>
                ...
                <td>Date of Birth: <input type="date" name="dob" max="<?= date('Y-m-d'); ?>" required>
            ...
            <tr>
                ...
                <td>Civil Status:<select name="civil_status" required>
                <option value="">-- Select --</option>
            ...
            <tr>
                ...
                <td>Date of Birth: <input type="date" name="spouse_dob"></td>
            </tr>
            <tr>
