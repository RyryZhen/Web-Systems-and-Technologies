<?php
include("../config/db.php"); // This already starts session
...
<head>
    ...
    <style>
        /* Basic styling, replace with your CSS framework if needed */
        body {
...
<body>
    ...
    <main>
        ...
        <!-- Example: Quick overview counts -->
        <?php
        // Count totals (safe queries)
