...
// Process approve/reject via POST (safer than GET)
      ...
      <div style="margin-top:1rem;">
        <form method="GET" style="display:inline;">
          <div class="live-search-container" style="display:flex;gap:.5rem;align-items:center;margin-top:0.75rem;">
            ...
            <select name="status" id="status_filter" onchange="this.form.submit()" style="padding:0.5rem;border-radius:4px;border:1px solid #ddd;">
