...
// Accept POST (form) or GET (legacy links) for decisions
...
// Insert approval record using a prepared statement
...
// Optionally update thesis status for quick visibility
...
// Log it in activity_logs if table exists
