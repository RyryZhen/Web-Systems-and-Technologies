...
// Handle review decision via POST
...
// Fetch theses relevant to this faculty: adviser or pending
                  ...
                  <td class="table-actions">
                    ...
                    <?php if (!empty($t['faculty_decision'])): ?>
                      <?php if ($t['faculty_decision'] === 'approved'): ?>
                        ...
                        <!-- reject is disabled after approve -->
                        <button class="btn btn-danger" disabled>Reject</button>
                      <?php else: ?>
                        <!-- decision is rejected: show Undo and disabled Approve -->
