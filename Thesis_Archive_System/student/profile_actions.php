<?php
// profile_actions.php
// Shared upload handler for profile picture and signature
// Assumes $conn and session started and $_SESSION['user'] available
...
// Export $student and $message for including pages
