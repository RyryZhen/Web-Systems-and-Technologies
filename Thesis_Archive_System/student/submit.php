<?php
include("../config/db.php"); // Ensure this starts session and connects to DB
...
// Fetch departments & programs for dropdown
...
");
    ...
    if ($insert) {
        ...
        foreach ($_FILES['thesis_files']['name'] as $key => $filename) {
            ...
            // Change target directory as needed
        ...
        // Optional: log action in activity_logs
        mysqli_query($conn, "
...
<body>
    ...
    <!-- Notes -->
    <!-- 
1. Ensure directory '../uploads/thesis/' exists and is writable.
2. File validation (size/type) can be added for security.
3. Activity logging is optional but recommended.
4. After submission, student can view and edit via 'edit_thesis.php' page.
-->
